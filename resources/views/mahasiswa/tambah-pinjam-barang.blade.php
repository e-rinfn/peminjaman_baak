        ...
        <form action="{{ url('tambah-pinjam-barang') }}" method="POST">
            ...
            <div class="my-3 p-3 bg-body rounded shadow-sm">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" value="{{ Session::get('nim') }}" name="nim"
                            id="nim">
                    </div>
                </div>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{ Session::get('no_hp') }}" name="no_hp"
                            id="no_hp">
                    </div>
                </div>
            ...
            <div class="my-3 p-3 bg-body rounded shadow-sm">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" value="{{ Session::get('tgl_pinjam') }}"
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" value="{{ Session::get('tgl_kembali') }}"
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{ Session::get('alasan') }}" name="alasan"
                            id="alasan">
                    </div>
                </div>
            </div>
            ...
            <div class="my-3 p-3 bg-body rounded shadow-sm">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" value="{{ Session::get('pesan_admin') }}"
